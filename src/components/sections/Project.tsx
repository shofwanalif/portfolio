...
export function Project() {
  return (
    <>
      <BlurFade delay={0.25} inView direction="up" duration={1}>
        <div className="mb-10">
      ...
      <div className="grid gap-5 lg:grid-cols-12 lg:gap-6">
        ...
        >
          <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border bg-card text-card-foreground shadow-sm">
            ...
            <div className="flex flex-col p-6 sm:p-8">
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                administrators, the platform replaces fragmented manual
                workflows with a single, unified system that keeps every
                activity tracked, organized, and visible from end to end.
              </p>
          ...
          <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col p-6 sm:p-8">
              ...
              <p className="mt-4 text-muted-foreground">
                ...
                accesses only what their role permits from branch staff
                recording daily transactions to managers monitoring cross-branch
                performance eliminating the need for manual reconciliation and
          ...
          <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border bg-card text-card-foreground shadow-sm">
            <div className="flex flex-col p-6 sm:p-8">
              <h3 className="text-3xl font-semibold">
                Car Wash landing page & booking system
              </h3>
              <p className="mt-4 text-lg ">
                A landing page and online booking platform for a car wash
                service.
              </p>
              <p className="mt-4 text-muted-foreground">
                The site presents the service offering and lets customers book
                directly from the page selecting their preferred date and time
                slot without needing to call or visit in person.
              </p>
              <div className="mt-8 flex gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg border bg-background shadow-sm text-xl dark:invert">
                  <i className="devicon-nextjs-plain"></i>
            ...
            <div className="w-full aspect-4/3 flex items-center justify-center relative mt-auto overflow-hidden">
              <img
                src="/booking.png"
                alt="sirenta"
        ...
        >
          <div className="flex flex-1 flex-col overflow-hidden rounded-2xl border bg-card text-card-foreground shadow-sm">
            ...
            <div className="flex flex-col p-6 sm:p-8">
              <h3 className="text-3xl font-semibold">
                Netradaya Power Monitoring System
              </h3>
              <p className="mt-4 text-lg">
                An IoT-based real-time electrical monitoring system that tracks
                voltage and load activity as it happens.
              </p>
              <p className="mt-4 text-muted-foreground">
                Sensor data from ACS and ZMPT modules is streamed directly to
                the dashboard via WebSocket, giving operators an up-to-date view
                of current electrical conditions without manual polling. The
                system also monitors threshold boundaries in real time.
                Triggering instant notifications whenever voltage drops, spikes,
                or load anomalies are detected.
              </p>
              <div className="mt-8 flex gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-lg border bg-background shadow-sm text-xl dark:invert">
                  <i className="devicon-nextjs-plain"></i>
